...
@Mod(AE2AddonLib.MODID)
public class AE2AddonLib {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "ae2addonlib";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public AE2AddonLib(IEventBus modEventBus, ModContainer modContainer) {
    ...
    // @SubscribeEvent
    @EventBusSubscriber(modid = AE2AddonLib.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
